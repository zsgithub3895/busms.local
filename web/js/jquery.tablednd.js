...
jQuery.tableDnD = {
    ...
    dragObject: null,
    dragObject_original_index:null,
    ...
    initialiseDrag: function(dragObject, table, target, evnt, config) {
        ...
        $(dragObject).addClass('in-drag');
        $(table).find('tbody tr').each(function(i,e){
        	if(dragObject == this){
        		jQuery.tableDnD.dragObject_original_index = ++i;
//        		console.log('original_index:'+i);
        	}
        });
    ...
    mousemove: function(ev) {
        ...
        if (y != jQuery.tableDnD.oldY) {
            ...
            if (currentRow) {
                ...
                if (movingDown && jQuery.tableDnD.dragObject != currentRow && $(currentRow).parent()[0] == jQuery.tableDnD.dragObject.parentNode) {
                    jQuery.tableDnD.dragObject.parentNode.insertBefore(jQuery.tableDnD.dragObject, currentRow.nextSibling);
                } else if (! movingDown && jQuery.tableDnD.dragObject != currentRow && $(currentRow).parent()[0] == jQuery.tableDnD.dragObject.parentNode) {
    ...
    mouseup: function(e) {
        if (jQuery.tableDnD.currentTable && jQuery.tableDnD.dragObject) {
            ...
            var new_index = 0;
            $(jQuery.tableDnD.currentTable).find('tbody tr').each(function(i,e){
            	if(jQuery.tableDnD.dragObject == this){
            		new_index = ++i;
//            		console.log('new_index:'+i);
            	}
            });
            $(jQuery.tableDnD.dragObject).removeClass('in-drag');
            jQuery.tableDnD.dragObject = null;
            var newOrder = jQuery.tableDnD.serialize();
            if (config.onDrop && jQuery.tableDnD.dragObject_original_index != new_index) {
                // Call the onDrop method if there is one
                config.onDrop(jQuery.tableDnD.currentTable, droppedRow ,new_index);
            }
