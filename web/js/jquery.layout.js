 ...
 */
	...
	,	scrollToBookmarkOnLoad:		false		// after creating a layout, scroll to bookmark in URL (.../page.htm#myBookmark)
	...
	,	defaults: { // default options for 'all panes' - will be overridden by 'per-pane settings'
		...
		,	spacing_closed:			2			// ditto - when pane is 'closed'
